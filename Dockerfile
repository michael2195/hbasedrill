...
COPY apache-drill*.tar.gz /opt/drill
RUN cd /opt/drill && tar -zxvf apache-drill* && rm apache-drill*.tar.gz
RUN ls /opt/drill/apache-drill-1.19.0/ 
RUN apt update 
...
ENV DRILL_HOME=/opt/drill/apache-drill-1.19.0
